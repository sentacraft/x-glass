...
export default function BrandFilterMenu({
  ...
  return (
    <Menu.Root>
      <Menu.Trigger
        className={cn(
          "inline-flex h-9 max-w-[60%] items-center justify-between gap-1.5 rounded-full border px-3.5 text-[12px] shadow-sm shadow-zinc-950/[0.02] transition-all duration-200 outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 sm:h-8.5 sm:min-w-28",
          hasSelection
