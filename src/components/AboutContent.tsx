  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 pt-4 sm:pt-12 pb-12 flex flex-col gap-6">
      ...
      <Section id="data-accuracy" title={t("dataAccuracyTitle")}>
        ...
        <ExternalLink
          href="https://github.com/sentacraft/x-glass#data-pipeline"
          className="group flex items-center gap-3 rounded-lg border border-zinc-200 bg-white px-4 py-3 transition-colors hover:border-zinc-300 hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900/40 dark:hover:border-zinc-600 dark:hover:bg-zinc-900"
        >
          <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" aria-hidden="true" className="shrink-0 text-zinc-700 dark:text-zinc-300">
          ...
          <span className="inline-flex items-center gap-0.5 shrink-0 text-xs font-medium text-zinc-600 group-hover:text-zinc-900 dark:text-zinc-400 dark:group-hover:text-zinc-100 transition-colors">
